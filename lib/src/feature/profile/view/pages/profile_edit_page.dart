  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              ProfileEditTextfieldWidget(
                ...
                hintText: ctr.selectedDate != null
                    ? "${ctr.selectedDate!.day}-${ctr.selectedDate!.month}-${ctr.selectedDate!.year}"
                    : "",
              ),
              30.verticalSpace,
            ],
      ...
      bottomSheet: ButtonWidget(
        ...
        onPressed: () {
          AppStorage.$write(
              key: StorageKey.name, value: ctr.ismTextEditingController.text);
          AppStorage.$write(
              key: StorageKey.lastName,
              value: ctr.familiyaTextEditingController.text);
          AppStorage.$write(
              key: StorageKey.date, value: ctr.sanaTextEditingController.text);
        },
      ),
    );
  }
